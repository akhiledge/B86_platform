...
rbtree *create(rbtree *root,
        int val) ///Function definition for creating a nod which takes an \
           arguments root which is pointer to a structure of rbtree and \
           value is of type integer and it returns pointer to structure rbtree 
{                                                                               
    rbtree *newnode = NULL;                        
